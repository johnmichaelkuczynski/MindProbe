...
Think very carefully about your answer and do not default to cookbook, midwit evaluation protocols. Do not give credit merely for use of jargon or for referencing authorities. Focus on substance and actual quality.`;
  ...
  private getCognitiveQuestions(): AnalysisQuestion[] {
    return [
      ...
      // New pseudo-intellectual detection questions
      { id: '19', question: 'Are there terms that are undefined but should be defined? Are there undefined terms with no canonical meanings that function as meaningless placeholders?', order: 19 },
      { id: '20', question: 'Are there "free variables" in the text? Are there qualifications or points that are made but do not connect to anything later or earlier?', order: 20 },
      { id: '21', question: 'Do new statements develop out of old ones? Or are they merely "added" to previous ones, without in any sense being generated by them?', order: 21 },
      { id: '22', question: 'Do new statements clarify or do they lead to more lack of clarity?', order: 22 },
      { id: '23', question: 'Is the passage actually (palpably) smart? Or is it only "presumption-smart"? Is it "smart" only because there exists a presumption that a dumb person would not reference such doctrines?', order: 23 },
      { id: '24', question: 'If your judgment is that it is insightful, can you state that insight in a single sentence? Or if it contains multiple insights, can you state those insights, one per sentence?', order: 24 },
    ];
  }
